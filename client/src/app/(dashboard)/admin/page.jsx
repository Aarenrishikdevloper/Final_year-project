...
//   "0x9CEd55FadE3c88014719DA04bdFE008Bd81dB07d";
...
const Page = () => {
      ...
      try {
        ...
        window.ethereum.on("accountsChanged", (newAccounts) => {
          if (newAccounts.length > 0) {
            setAccount(newAccounts[0]); // Update the active account
          } else {
        ...
        // Dynamically fetch the contract address from the JSON file
  ...
  const handleAddInstitute = async () => {
    ...
    try {
      ...
      console.error("Error adding institute:", error);
      if (
        error.message.includes("This account has already created an institute")
      ) {
        alert("You can only create one institute per account.");
      } else {
        alert("Failed to add institute. Check console for errors.");
      }
    } finally {
